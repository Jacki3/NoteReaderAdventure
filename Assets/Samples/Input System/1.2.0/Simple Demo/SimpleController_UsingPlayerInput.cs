...
public class SimpleController_UsingPlayerInput : MonoBehaviour
{
    ...
    public void OnGUI()
    {
        if (m_Charging) GUI.Label(new Rect(100, 100, 200, 100), "Charging...");
    }
    ...
    private void Look(Vector2 rotate)
    {
        ...
        m_Rotation.x =
            Mathf.Clamp(m_Rotation.x - rotate.y * scaledRotateSpeed, -89, 89);
    ...
    private void Fire()
    {
        ...
        newProjectile
            ...
            .AddForce(transform.forward * 20f, ForceMode.Impulse);
